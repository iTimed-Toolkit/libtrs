...
void expand_key(uint8_t key[16], uint8_t key_sched[176], int n)
{
...
void aes128_ttable_encrypt_ecb(uint8_t *msg,
                               uint8_t key_sched[176])
{
    ...
    for(i = 1; i < 10; ++i)
    {
        u0 = const_t0[(uint8_t) t0] ^
             const_t1[(uint8_t) (t1 >> 8u)] ^
             const_t2[(uint8_t) (t2 >> 16u)] ^
             const_t3[(uint8_t) (t3 >> 24u)];

        u1 = const_t0[(uint8_t) t1] ^
             const_t1[(uint8_t) (t2 >> 8u)] ^
             const_t2[(uint8_t) (t3 >> 16u)] ^
             const_t3[(uint8_t) (t0 >> 24u)];

        u2 = const_t0[(uint8_t) t2] ^
             const_t1[(uint8_t) (t3 >> 8u)] ^
             const_t2[(uint8_t) (t0 >> 16u)] ^
             const_t3[(uint8_t) (t1 >> 24u)];

        u3 = const_t0[(uint8_t) t3] ^
             const_t1[(uint8_t) (t0 >> 8u)] ^
             const_t2[(uint8_t) (t1 >> 16u)] ^
             const_t3[(uint8_t) (t2 >> 24u)];
    ...
    msg_int[0] = ((uint32_t) const_sbox[(uint8_t) (t0 >> 0u)] << 0u |
                  (uint32_t) const_sbox[(uint8_t) (t1 >> 8u)] << 8u |
                  (uint32_t) const_sbox[(uint8_t) (t2 >> 16u)] << 16u |
                  (uint32_t) const_sbox[(uint8_t) (t3 >> 24u)] << 24u) ^
                 key_sched_int[4 * i];

    msg_int[1] = ((uint32_t) const_sbox[(uint8_t) (t1 >> 0u)] << 0u |
                  (uint32_t) const_sbox[(uint8_t) (t2 >> 8u)] << 8u |
                  (uint32_t) const_sbox[(uint8_t) (t3 >> 16u)] << 16u |
                  (uint32_t) const_sbox[(uint8_t) (t0 >> 24u)] << 24u) ^
                 key_sched_int[4 * i + 1];

    msg_int[2] = ((uint32_t) const_sbox[(uint8_t) (t2 >> 0u)] << 0u |
                  (uint32_t) const_sbox[(uint8_t) (t3 >> 8u)] << 8u |
                  (uint32_t) const_sbox[(uint8_t) (t0 >> 16u)] << 16u |
                  (uint32_t) const_sbox[(uint8_t) (t1 >> 24u)] << 24u) ^
                 key_sched_int[4 * i + 2];

    msg_int[3] = ((uint32_t) const_sbox[(uint8_t) (t3 >> 0u)] << 0u |
                  (uint32_t) const_sbox[(uint8_t) (t0 >> 8u)] << 8u |
                  (uint32_t) const_sbox[(uint8_t) (t1 >> 16u)] << 16u |
                  (uint32_t) const_sbox[(uint8_t) (t2 >> 24u)] << 24u) ^
                 key_sched_int[4 * i + 3];
}